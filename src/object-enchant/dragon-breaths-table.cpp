...
const dragonbreath_type dragonbreath_info[]
    = { { TR_RES_ACID, GF_ACID, _("酸", "acid") }, { TR_RES_ELEC, GF_ELEC, _("電撃", "lightning") }, { TR_RES_FIRE, GF_FIRE, _("火炎", "fire") },
          { TR_RES_COLD, GF_COLD, _("冷気", "cold") }, { TR_RES_POIS, GF_POIS, _("毒", "poison") }, { TR_RES_LITE, GF_LITE, _("閃光", "light") },
